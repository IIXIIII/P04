...
//
// Title:    Exceptional Course Enrollment 
...
//TODO Uncomment the below methods out after declaring the data fields
  ...
  public void addWaitlist(StudentRecord student) {
    ...
    // method FIRST!
    // You can use ArrayList.contains() method to check whether there is a match with student in
    // roster or waitlist
  }
  ...
  public void enrollOneStudent(StudentRecord student) {
    ...
    // [Hint] You can use ArrayList.contains() and ArrayList.remove(Object) to implement this method
...
//TODO Uncomment the below methods out after declaring the data fields
  ...
  public void loadRoster(File rosterFile) {
    // Hint1: Use a scanner to read rosterFile!
    // Hint2: Use the lineToRecord() method to parse every line in the file
    // Hint3: Use the enrollOneStudent() method to try enrolling every parsed student record
  }
